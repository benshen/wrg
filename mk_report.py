...
def generate_report(root, filename, attend_staff, absent_staff, meeting_direct, record_staff, reports, issues):
    ...
    sheet1.write_merge(line_counter,line_counter,0,3, 'summary', style_title)
    ...
    sheet1.write_merge(line_counter,line_counter,0,3, 'Main Issues List', style_title)    
    line_counter += 1

    sheet1.row(line_counter).write(0, 'Items', sytle_tb_header)
    sheet1.write_merge(line_counter, line_counter, 1, 2, 'Deatail', sytle_tb_header)
